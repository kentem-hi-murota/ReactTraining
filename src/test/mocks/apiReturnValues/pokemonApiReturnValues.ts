...
export const paginationUrlHead = {
  count: 1302,
...
export const paginationUrlMiddle = {
  count: 1302,
  next: 'https://pokeapi.co/api/v2/pokemon?offset=22&limit=2',
...
export const paginationUrlTail = {
  count: 1302,
  next: null,
  previous: 'https://pokeapi.co/api/v2/pokemon?offset=1298&limit=2',
  results: [
    {
